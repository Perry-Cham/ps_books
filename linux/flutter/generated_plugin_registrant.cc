...
#include <pdf_renderer_bridge/pdf_renderer_bridge_plugin.h>
...
void fl_register_plugins(FlPluginRegistry* registry) {
  ...
  g_autoptr(FlPluginRegistrar) pdf_renderer_bridge_registrar =
      fl_plugin_registry_get_registrar_for_plugin(registry, "PdfRendererBridgePlugin");
  pdf_renderer_bridge_plugin_register_with_registrar(pdf_renderer_bridge_registrar);
