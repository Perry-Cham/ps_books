...
class AiChatWidget extends StatefulWidget {
  ...
  ///
  /// When provided, a three-dot icon appears in the footer of each message
  /// bubble. Tapping it shows the widget returned by this function as a popup
  /// menu. The function receives the message text as an argument.
  ///
  /// ```dart
  /// AiChatWidget(
  ///   customContextMenu: (text) => PopupMenuButton<String>(
  ///     onSelected: (value) { ... },
  ///     itemBuilder: (ctx) => [
  ...
  /// ```
  ///
  /// Defaults to null (no icon shown).
          ...
          children: [
            ...
            Expanded(
              child: CustomChatWidget(
                ...
                customContextMenu: widget.customContextMenu,
              ),
            ),
