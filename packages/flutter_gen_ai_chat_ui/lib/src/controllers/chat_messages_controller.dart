...
class ChatMessagesController extends ChangeNotifier {
  ...
  void addMessage(ChatMessage message) {
    ...
    if (!_messageCache.containsKey(messageId)) {
      ...
      // unless isStreaming is explicitly set to false (instant/non-streaming).
      if (!isFromUser) {
        final explicitIsStreaming =
            message.customProperties?['isStreaming'] as bool?;
        if (explicitIsStreaming != false) {
          setStreamingMessage(messageId);
        }
      }
