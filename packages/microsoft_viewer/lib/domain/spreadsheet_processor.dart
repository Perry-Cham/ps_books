...
class SpreadsheetProcessor {
  ...
  Future<List<Widget>> displaySpreadSheet(
      SpreadSheet spreadSheet, List<SharedString> sharedStrings, List<SSStyle> spreadSheetStyles, List<SSColorSchemes> colorSchemes, {double width = 500}) async {
    ...
    for (int i = 0; i < spreadSheet.sheets.length; i++) {
      ...
      sheetWidgets.add(
        Container(color: Colors.white, width: width, margin: const EdgeInsets.all(8), child: SingleChildScrollView(child: HtmlWidget(htmlString))),
      );
    }
