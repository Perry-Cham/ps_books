...
class DestinationTree extends StatefulWidget {
  ...
  @override
  State<DestinationTree> createState() => _DestinationTreeState();
}

class _DestinationTreeState extends State<DestinationTree> {
  ...
  @override
  void didUpdateWidget(covariant DestinationTree oldWidget) {
